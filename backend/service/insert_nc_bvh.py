...
# """
# def insert_nc_bvh(db: Session, q: queue.Queue, file_name):
#     # print("insert_bvh")
#     match file_name:
#         case "clapOverHead":
...
#     check_name_match(file_name, choreography_models.ClapOverHeadNC.__tablename__)
    
#     while not q.empty():
#         insert_data = _create_clap_over_head(q)
#         db_obj = choreography_models.ClapOverHeadNC(**insert_data.dict())
...
#     check_name_match(file_name, choreography_models.DownTwoTimesNC.__tablename__)

#     while not q.empty():
#         insert_data = _create_down_two_times(q)
#         db_obj = choreography_models.DownTwoTimesNC(**insert_data.dict())
#         db_objs.append(db_obj)
#         count += 1
...
#     check_name_match(file_name, choreography_models.FrontBackNC.__tablename__)

#     while not q.empty():
#         insert_data = _create_front_back(q)
#         db_obj = choreography_models.FrontBackNC(**insert_data.dict())
#         db_objs.append(db_obj)
#         count += 1
...
#     check_name_match(file_name, choreography_models.JumpNC.__tablename__)

#     while not q.empty():
#         insert_data = _create_jump(q)

#         db_obj = choreography_models.JumpNC(**insert_data.dict())
#         db_objs.append(db_obj)
#         count += 1
...
#     check_name_match(file_name, choreography_models.LeftArmAndLegSideNC.__tablename__)

#     while not q.empty():
#         insert_data = _create_l_arm_and_leg_side(q)

#         db_obj = choreography_models.LeftArmAndLegSideNC(**insert_data.dict())
#         db_objs.append(db_obj)
#         count += 1
...
#     check_name_match(file_name, choreography_models.RightArmAndLegSideNC.__tablename__)

#     while not q.empty():
#         insert_data = _create_r_arm_and_leg_side(q)

#         db_obj = choreography_models.RightArmAndLegSideNC(**insert_data.dict())
#         db_objs.append(db_obj)
#         count += 1
