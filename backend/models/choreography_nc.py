...
class ClapOverHead(Base):
    __tablename__ = "clap_over_head_nc"
...
class DownTwoTimes(Base):
    __tablename__ = "down_two_times_nc"
...
class LeftArmAndLegSide(Base):
    __tablename__ = "l_arm_and_leg_side_nc"
...
class RightArmAndLegSide(Base):
    __tablename__ = "r_arm_and_leg_side_nc"
